...
@section("topSection")
    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
        <h3 class="font-weight-bold">Add Instructor</h3>
    </div>
@endsection
...
@section('content')
    <div class="col-12 mt-3">
        <div class="row">
            <form style="width: 100%" action="{{ route('admin.instructors.store') }}" method="POST">
                @csrf
                <div class="row">
                    <!-- Full Name -->
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6 mt-3">
                        ...
                        <input class="form-control" value="{{ old('designation') }}" type="text" name="designation" id="designation">
                    ...
                    <div class="col-lg-6 mt-3">
                        ...
                        <input class="form-control" value="{{ old('final_qualification') }}" type="text" name="final_qualification" id="final_qualification">
