...
@section("topSection")
    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
        <h3 class="font-weight-bold">Add Study Material</h3>
    </div>
@endsection
...
@section('content')
    <div class="col-12 mt-3">
        <div class="row">
            <form style="width: 100%" action="{{ route('instructor.study.material.store') }}" method="POST"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 ">
                        <label for="assignment_file">Upload Study Material (PDF only)</label>
                        <input class="form-control" type="file" accept=".pdf" name="study_file" id="assignment_file"
                ...
                <div class="row mt-4">
                    <div class="col-2">
                        <input type="submit" value="Save Material" class="btn btn-md btn-primary">
                    </div>
                </div>
            </form>
        </div>
