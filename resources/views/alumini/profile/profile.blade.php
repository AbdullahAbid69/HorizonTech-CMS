...
@section('content')
    <div class="col-12 mt-3">
        <form action="{{route("alunimi.profile.update")}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                {{-- Profile Image --}}
                <div class="col-lg-12 text-center mb-4">
                    <div class="profile-image-wrapper mb-2">
                        <img id="profile-preview" src="{{ asset(Auth::user()->profile_image) }}" alt="Profile Image"
